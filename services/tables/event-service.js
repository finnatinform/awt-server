...
module.exports = {
    ...
    listEvents(_DataBase, _Callback) {
        _DataBase.all("SELECT E.*, R.FORE_NAME,R.SURE_NAME, COALESCE(L.USER_IDENT,0,1) as USER_HAS_RESERVED FROM EVENTS as E LEFT JOIN REFERENTS as R LEFT JOIN USERS_EVENTS_LINK as L ON E.REFERENT_IDENT = R.IDENT AND E.IDENT=L.EVENT_IDENT", [], function (_Error, _EventRows) {
