module.exports = {
    BuildDatabase : function(_Database){
        ...
        _Database.serialize(function() {    
            ...
            _Database.run("CREATE TABLE if not exists USERS_EVENTS_LINK (USER_IDENT INTEGER, EVENT_IDENT INTEGER, RESERVED INTEGER, RESERVED_ON TEXT, FOREIGN KEY(USER_IDENT) REFERENCES USERS(IDENT), FOREIGN KEY(IDENT) REFERENCES EVENTS(IDENT))");
